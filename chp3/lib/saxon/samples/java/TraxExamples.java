...
public class TraxExamples {
    ...
    public static void main(String argv[]) {
        ...
        if (test.equals("all") || test.equals("exampleSAXResult")) {
            System.out.println("\n\n==== exampleSAXResult ====");
        ...
        if (test.equals("all") || test.equals("exampleSaxonToSaxon")) {
            System.out.println("\n\n==== exampleSaxonToSaxon ====");
        ...
        if (test.equals("all") || test.equals("exampleSaxonToSaxonNonRoot")) {
        ...
        if (test.equals("all") || test.equals("exampleDOMsubtree")) {
            System.out.println("\n\n==== exampleDOMsubtree ====");
        ...
        if (test.equals("all") || test.equals("exampleDOMtoDOMAlienDoc")) {
            System.out.println("\n\n==== exampleDOMtoDOMAlienDoc ====");
        ...
        if (test.equals("all") || test.equals("exampleNewDOMSerializer")) {
        ...
        if (test.equals("all") || test.equals("exampleUsingOutputURIResolver")) {
    ...
    */
    ...
    public static void exampleUsingOutputURIResolver(String sourceID, String xslID)
            throws TransformerException, TransformerConfigurationException {
        ...
        tfactory.setAttribute("http://saxon.sf.net/feature/allow-external-functions",
                                new Boolean(true));     // this is the default
    ...
    */
    ...
    public static void exampleAsSerializer(String sourceID)
        ...
        oprops.put("{http://saxon.sf.net/}indent-spaces", "2");
