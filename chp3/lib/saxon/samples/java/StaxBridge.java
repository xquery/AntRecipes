 ...
 * (or any other StAX implementation)
 */
...
public class StaxBridge implements PullProvider {
    ...
    public CharSequence getStringValue() throws XPathException {
        switch (currentEvent) {
            ...
            case PROCESSING_INSTRUCTION:
                ...
                // StAX (or at any rate, the BEA parser) includes the separator space in the value,
    ...
    private class StaxAttributes implements AttributeCollection {
         ...
         *
         * @param index The position of the attribute in the list.
         * @return The type annotation, defaulting to -1 for an untyped attribute
         */
        ...
        public int getProperties(int index) {
            ...
            if (reader.getAttributeType(index).equals("ID")) {
                properties |= ReceiverOptions.DTD_ID_ATTRIBUTE;
                // Unfortunately the BEA parser doesn't see to report attribute types...
            }
            return properties;
        }
